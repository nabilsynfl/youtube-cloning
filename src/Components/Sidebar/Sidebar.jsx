...
const Sidebar = () => {
      ...
      const [selectedId, setSelectionId] = useState("home")
      ...
      <div className="sidebarSection close" id='sidebarContainer'>
        <div className="miniSidebar" id='miniSidebar'>
            {sideBarData.mainTabs.map((tab, i)=>{
                  return <div key={i} className={`miniSidebarTab ${tab.icon === selectedId && 'active'}`} onClick={()=> setSelectionId(tab.icon)}>
        ...
        <div className="sidebarContainer" id='sidebarContainer'>
          <div className="sideBarTabs">
            <div className="tabContainer">
              {sideBarData.mainTabs.map((tab, i)=>{
                  return <div key={i} className={`sidebarTab ${tab.icon === selectedId && 'active'}`} onClick={()=> setSelectionId(tab.icon)}>
                    <span className="material-symbols-rounded">{tab.icon}</span>
                    {tab.head}  
                  </div>
              })}
